...
const allMenuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/cleanup', name: '数据清理', icon: 'trash' }
    ]
  }
]
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <div v-for="group in menuGroups" :key="group.title" class="nav-group">
          ...
          <svg v-else-if="item.icon === 'trash'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
