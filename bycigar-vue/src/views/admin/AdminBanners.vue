  ...
  <div class="admin-banners">
    <div class="toolbar">
      <div class="toolbar-left">
        <button class="btn-refresh" :class="{ spinning: loading }" @click="fetchBanners" title="刷新轮播图列表">
    ...
    <div class="content-tips">
      <div class="tip-item">
        <strong>推荐尺寸：</strong>4800 × 1840px（宽高比 60:23）
      </div>
      <div class="tip-item">
        ...
        <div class="modal">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <AdminImageUpload v-model="form.imageUrl" :aspect-ratio="60/23" />
              <div class="field-hint">推荐尺寸 4800×1840px，适合展示品牌形象、新品、活动等内容</div>
            </div>
            <div class="form-group">
              <label>跳转链接</label>
